...
El análisis de una serie de tiempo se compone de dos partes:
...
# Esta función permite leer los datos de la serie de tiempo
...
# Cargar datos
imae <- read_excel(
  "Recursos/datos/imae_ready.xlsx") |> 
  mutate(fecha = as.Date(fecha))
```

## Estrucutra de los datos

```{r, echo=TRUE, fig.align='center', fig.width=3, fig.height=3}
tail(imae |> select(fecha:indice_original)) |> 
